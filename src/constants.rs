...
pub(crate) const XSUM_SIGN_MASK: u64 = 1u64 << XSUM_SIGN_BIT; // Mask for sign bit
...
pub(crate) const XSUM_SCHUNKS: i64 = (1 << XSUM_HIGH_EXP_BITS) + 3; // # of chunks in small accumulator
